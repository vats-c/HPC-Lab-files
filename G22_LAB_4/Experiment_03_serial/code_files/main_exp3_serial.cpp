...
// Purely serial mover
void mover_serial(double* points_x, double* points_y, int num_points, double dx, double dy) {
    std::mt19937 rng(42); 
...
int main() {
    ...
    std::ofstream outfile("../data_cluster/exp3_results_serial.csv");
    ...
    for (int iter = 1; iter <= maxiter; ++iter) {
        ...
        mover_serial(points_x, points_y, num_particles, dx, dy);
        ...
        std::cout << "Serial Iter " << iter << " | Mover: " << mover_time << "s\n";
    }
